...
function buildProjectCode(form, projects) {
  const prefix = projectCodePrefix(form.projectName)
...
function EmployeeProjectPage() {
  ...
  const buildCreatePayload = (existingProjects = projects) => {
    ...
    if (form.personKind === PERSON_KIND_NONE) {
      payload.projectCode = isProjectCodeManual
                  ...
                  <div className="space-y-2 rounded-lg border bg-muted/20 px-4 py-3">
                    ...
                    <div className="flex flex-col gap-2 sm:flex-row">
                      <Input
                        ...
                        placeholder="Enter a project name first"
                        disabled={isEdit}
                        readOnly={isEdit}
                    ...
                    <p className="text-xs text-muted-foreground">
                      {isEdit
                        ...
                        : 'Only no-person projects send this code from the frontend. You can edit it before save.'}
                    </p>
                  </div>
                ) : null}
