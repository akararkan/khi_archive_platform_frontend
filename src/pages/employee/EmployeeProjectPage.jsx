                    ...
                    <div className="pt-2">
                      ...
                      {isEdit ? null : (
                        <p className="pt-1 text-xs text-muted-foreground">
                          The backend will generate the final project code after save, and later media codes will be generated from that saved project code.
                        </p>
                      )}
                    </div>
                  ) : (
                    <p className="pt-1 text-xs text-muted-foreground">
                      The backend will generate the final project code from the project name after save, for example{' '}
                      <span className="font-mono font-semibold text-foreground">NATURE-PROJ-000006</span>. Media codes are also generated by the backend.
                    </p>
                  )}
                </div>
