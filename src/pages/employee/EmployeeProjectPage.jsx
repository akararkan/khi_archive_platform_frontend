...
function buildProjectCode(form, projects) {
  const prefix =
    form.personKind === PERSON_KIND_PERSON && form.personCode.trim()
      ? projectCodePrefix(form.personCode)
      : projectCodePrefix(form.projectName)
  return `${prefix}-PROJ-${nextProjectCodeNumber(projects)}`
}
                    ...
                    <div className="pt-2">
                      ...
                      {isEdit ? null : (
                        <p className="pt-1 text-xs text-muted-foreground">
                          The frontend will send a project code like{' '}
                          <span className="font-mono font-semibold text-foreground">PERSONCODE-PROJ-000001</span>. Media codes are generated by the backend after save.
                        </p>
                      )}
                    </div>
                  ) : (
                    <p className="pt-1 text-xs text-muted-foreground">
                      The frontend will send a project-name code like{' '}
                      <span className="font-mono font-semibold text-foreground">NATURE-PROJ-000006</span>. Media codes are generated by the backend after save.
                    </p>
                  )}
                </div>
