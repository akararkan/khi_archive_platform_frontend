const textFieldsMetadata = {
  ...
  volumeName: {
    ...
    description: 'ناوی درایڤ، تەنها کاتێک سیستەمی ئامێرەکە ڕێگای فایل پیشان بدات. وێبگەڕە ئاساییەکان ئەم زانیارییە دەپارێزن.',
  },
  directory: {
    title: 'دایرێکتۆری',
  ...
  autoPath: {
    title: 'ڕێگای خۆکار',
    description: 'ڕێگای ئۆتۆماتیکی فایل؛ ئەگەر وێبگەڕ ڕێگا بشارێتەوە، ناوی فایل بەکاردێت.',
  },
