...
const navigationGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'List of Items', to: '/admin/items', icon: Library },
      { label: 'Maqam List', to: '/admin/maqam', icon: Music4 },
      { label: 'Physical Media', to: '/admin/physical-media', icon: HardDrive },
      { label: 'Tags & Keywords', to: '/admin/vocabulary', icon: Hash },
