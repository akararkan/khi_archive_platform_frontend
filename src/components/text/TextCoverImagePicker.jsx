...
function CoverArtwork({ src, alt, hasSelectedFile }) {
 ...
 * `file` is the pending multipart replacement; `currentUrl` is the cover already
 * stored by the backend. Clearing a pending file reveals the current cover and
 * never implies deletion of that stored asset.
 */
