...
export const IconHome = (p) => <Svg {...p}><path d="M3 11.5 12 4l9 7.5M5 10v10h14V10" strokeLinecap="round" strokeLinejoin="round" /></Svg>
export const IconPlus = (p) => <Svg sw={2.2} {...p}><path d="M12 5v14M5 12h14" strokeLinecap="round" /></Svg>
export const IconLayers = (p) => <Svg {...p}><path d="m12 3 9 5-9 5-9-5 9-5zM3 13l9 5 9-5M3 17l9 5 9-5" strokeLinejoin="round" /></Svg>
export const IconTag = (p) => <Svg {...p}><path d="M3 12V5a2 2 0 0 1 2-2h7l9 9-9 9-9-9z" strokeLinejoin="round" /><circle cx="7.5" cy="7.5" r="1.3" fill="currentColor" /></Svg>
export const IconQuote = (p) => <Svg {...p}><path d="M7 7H4v6h5V9c0 2-1 3-3 3M19 7h-3v6h5V9c0 2-1 3-3 3" strokeLinecap="round" strokeLinejoin="round" /></Svg>
