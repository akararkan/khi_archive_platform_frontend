...
import {
  KhiBreadcrumb, KhiDetailHero, KhiDetailDisc, KhiActions,
} from './KhiDetail'
...
// it out the heritage way: hero → content → metadata ledger → year.
...
export default function KhiMediaDetail({
  ...
  return (
    <>
      ...
      />
      {/* No info-card strip: every one of those facts repeats verbatim in the
          metadata ledger below, so it was pure duplication. */}
      {content}
