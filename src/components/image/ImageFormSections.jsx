        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              {isPublic
                ? 'This image is visible to all public visitors and can be searched.'
      ...
      <Card className="border-border bg-card shadow-sm shadow-black/5">
        ...
        <CardContent className="grid gap-5 pt-5 sm:grid-cols-2">
          <div className="space-y-1.5">
            ...
            <Input id="img-volumeName" value={form.volumeName} onChange={(e) => setForm({ ...form, volumeName: getVolumeNameFromPath(e.target.value) || e.target.value })} placeholder="Volume name or /Volumes/Hard1/…" />
          </div>
          <div className="space-y-1.5">
            <ImageFieldLabel htmlFor="img-directory">Directory</ImageFieldLabel>
            <Input id="img-directory" value={form.directory} onChange={(e) => setForm({ ...form, directory: e.target.value })} placeholder="Parent folder" />
          </div>
          <div className="space-y-1.5">
          ...
          <div className="space-y-1.5">
            ...
            <Input id="img-autoPath" value={form.autoPath} onChange={(e) => setForm({ ...form, autoPath: e.target.value })} placeholder="e.g. https://cloud.khi.org/image/…" />
          </div>
        </CardContent>
      </Card>
