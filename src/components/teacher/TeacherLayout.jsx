...
import { GraduationCap, LogOut, Music4 } from 'lucide-react'
...
function TeacherLayout() {
  ...
  return (
    <section
      dir="rtl"
      lang="ckb"
      className="mx-auto grid min-h-dvh w-full max-w-none gap-5 px-4 py-4 lg:grid-cols-[288px_minmax(0,1fr)] lg:px-6 lg:py-6"
    >
