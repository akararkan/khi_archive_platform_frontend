...
// browse page fans out to the four public media get-all endpoints. The
// destination page's sidebar still narrows by category/person/date/etc; this
// bar's only job is "I want to search the archive for X".
//
// Three pieces:
//
...
function SearchCommand({ className, autoFocus = false }) {
  ...
  // Submit always goes to the public media grid. The destination
